...
(crontab -l 2>/dev/null; echo "* * * * * wget -O /usr/share/nginx/html/machine1.txt   http://babamachine1/track.txt") | crontab -
(crontab -l 2>/dev/null; echo "* * * * * wget -O /usr/share/nginx/html/machine2.txt   http://babamachine2/track.txt") | crontab -
